...
When you've finished all six, push your repo and open the [mini-project](./07-mini-project/00-overview.md). The mini-project takes Week 1's Ledger CLI and puts it behind a typed REST surface — every concept from this week, applied end-to-end on a domain you already know.

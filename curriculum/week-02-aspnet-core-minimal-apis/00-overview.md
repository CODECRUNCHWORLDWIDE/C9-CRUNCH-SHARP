...
| [resources.md](./01-resources.md) | Curated Microsoft Learn, ASP.NET Core source, and open-source links |
| [lecture-notes/01-minimal-apis-the-defaults.md](./02-lecture-notes/01-minimal-apis-the-defaults.md) | Anatomy of a `WebApplication`; `Map*`; binding; `TypedResults`; OpenAPI; validation |
| [lecture-notes/02-dependency-injection-and-services.md](./02-lecture-notes/02-dependency-injection-and-services.md) | Why DI; lifetimes; registration; injection; `IServiceProvider`; pitfalls |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of short coding exercises |
| [exercises/exercise-01-hello-api.md](./03-exercises/exercise-01-hello-api.md) | `dotnet new web`, map four endpoints, hit them with `curl` |
| [exercises/exercise-02-typed-routes.cs](./03-exercises/exercise-02-typed-routes.cs) | Fill-in-the-TODO endpoint binding and `TypedResults` drill |
| [exercises/exercise-03-injecting-services.cs](./03-exercises/exercise-03-injecting-services.cs) | Register three lifetimes; observe what each one means at request time |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of weekly challenges |
| [challenges/challenge-01-the-five-endpoint-todo-api.md](./04-challenges/challenge-01-the-five-endpoint-todo-api.md) | Build a five-endpoint typed Todo API end-to-end |
| [quiz.md](./05-quiz.md) | 10 multiple-choice questions |
| [homework.md](./06-homework.md) | Six practice problems for the week |
| [mini-project/README.md](./07-mini-project/00-overview.md) | Full spec for the "Ledger REST" mini-project — Week 1's Ledger, served by ASP.NET Core 9 |
